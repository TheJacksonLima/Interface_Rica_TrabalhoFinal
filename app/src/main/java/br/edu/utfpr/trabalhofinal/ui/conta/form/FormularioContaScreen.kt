...
import br.edu.utfpr.trabalhofinal.ui.utils.composables.DatePickerModalInput
...
private fun FormContent(
    ...
    var rdDespesa by remember { mutableStateOf(false) }
    var rdReceita by remember { mutableStateOf(false) }
    ...
    Column(
        ...
        Row(verticalAlignment = Alignment.CenterVertically) {
            ...
            Column(
                ...
                // Show the DatePickerModalInput dialog when showDatePicker is true
                if (showDatePicker) {
        ...
        Row(
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                Checkbox(
                    ...
                    onCheckedChange = {
                        isChecked = it
                        onStatusPagamentoAlterado(isChecked.toString())
                    }
                )
                Text(stringResource(R.string.paga))
            }
        }
        ...
        Row (
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                RadioButton(selected = rdDespesa, onClick = {onTipoAlterado("DESPESA") })
                Text(stringResource(R.string.despesa))
            }

            Spacer(Modifier.size(24.dp))

            Row(verticalAlignment = Alignment.CenterVertically) {
                RadioButton(selected = rdReceita, onClick = { onTipoAlterado("RECEITA") })
                Text(stringResource(R.string.receita))
            }
        }
    }
}
